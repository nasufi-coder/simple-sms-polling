...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'SMS Polling Simple API',
      version: '1.0.0',
      description: 'A lightweight SMS aggregation service that polls Twilio for incoming messages and extracts 2FA codes automatically.',
      contact: {
          ...
          properties: {
            ...
            sms_service: {
              ...
              properties: {
                connected: {
                  type: 'boolean',
                  description: 'Connection status to Twilio'
                },
                phoneNumber: {
                  type: 'string',
                  description: 'Your Twilio phone number'
